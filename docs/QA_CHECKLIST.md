...
- [ ] 効果音 confirm / back / jump / attack / boost / gacha reveal / mission clear / achievement / result fanfare が配置済みファイルで鳴る
- [ ] 効果音が表情操作で連打されすぎない

## iPhone checks

- [ ] Build 16 がインストールされている
...
- [ ] 将来のGame Center接続用 identifier が `BUILD_IOS.md` に記載されている
